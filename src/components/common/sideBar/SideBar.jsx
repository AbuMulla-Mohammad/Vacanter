                ...
                return (
                    <>
                        <ul className="flex flex-col gap-4 px-4 py-4 ">
                            <li className="w-full">
                                <NavLink to="/UserProfile/personalInfo" className="px-4 py-2  flex gap-4 font-medium  transition-all duration-500 rounded-lg hover:bg-primary-light hover:text-primary">
                ...
                return (
                    <>
                        <ul className="flex flex-col gap-4 px-4 py-4 ">
                            ...
                            <li className="w-full">
                                <NavLink to="/UserProfile/jobApplications" className="px-4 py-2  flex gap-4 font-medium  transition-all duration-500 rounded-lg hover:bg-primary-light hover:text-primary">
                                    <svg width={13} className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path d="M290.7 93.2l128 128-278 278-114.1 12.6C11.4 513.5-1.6 500.6 .1 485.3l12.7-114.2 277.9-277.9zm207.2-19.1l-60.1-60.1c-18.8-18.8-49.2-18.8-67.9 0l-56.6 56.6 128 128 56.6-56.6c18.8-18.8 18.8-49.2 0-67.9z" />
                                    </svg>
                                    Job Applications
