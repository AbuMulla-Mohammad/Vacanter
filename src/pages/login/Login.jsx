    ...
    return (
        <>
            <div className=' h-[650px] relative  flex justify-center items-center w-[70%] rounded-3xl overflow-hidden shadow-[6px_11px_57px_-12px_rgba(0,0,0,0.75)]' >
                ...
                <div className={`toggle-panel text-white w-[50%] min-h-full flex justify-evenly items-center flex-col p-[0_30px] rounded-[150px_0_0_100px] bg-primary translate-x-[100%] transition-all duration-700 ${animate ? 'translate-x-[0]' : ''}`} >
